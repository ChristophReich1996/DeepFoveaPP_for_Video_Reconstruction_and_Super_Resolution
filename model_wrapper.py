...
class ModelWrapper(object):
    ...
    def train(self, epochs: int = 1, save_models_after_n_epochs: int = 1, validate_after_n_epochs: int = 1,
              w_supervised_loss: float = 5.0, w_supervised_loss_low: float = 2.0, w_adversarial: float = 1.0 / 10,
              w_fft_adversarial: float = 1.0 / 10, w_perceptual: float = 1.0, w_flow: float = 2.0,
